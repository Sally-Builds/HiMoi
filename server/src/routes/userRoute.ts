...
import { getUserController, signupController, verifyController, getUsersController, resendOTPController, updateProfileController, getMeController, loginController, logoutController } from "../controllers";
...
userRouter.route('/').get(authenticate, getUsersController)
